...
public class MainActivity extends AppCompatActivity{
    ...
    private void initImageHorizontal() {
        Log.d(TAG, "initImageHorizontal: preparing bitmaps");
    ...
    private void initHorizontalRecycler() {
        Log.d(TAG, "initHorizontalRecycler: init recyclerview");
        LinearLayoutManager layoutManager = new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false);
        RecyclerView horizontal_re = findViewById(R.id.horizontal_recycler);
        horizontal_re.setLayoutManager(layoutManager);
        HorizontalRecyclerViewAdapter adapt = new HorizontalRecyclerViewAdapter(this, mNames, mImageURLs);
        horizontal_re.setAdapter(adapt);
    }
